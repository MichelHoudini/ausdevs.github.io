...
- **General Use Calculators:**
    ...
    - [**Home Loan Calculator**](https://figura.finance/calculators/repayments): Useful for calculating home loan repayments, etc.
        - [**Clearcut Calculators**](https://clearcutcalculators.com/): Useful for calculating Australian take-home pay, redundancy payout tax, CGT discount, and leave loading, etc. No login required.
- **Goverment Schemes:**
